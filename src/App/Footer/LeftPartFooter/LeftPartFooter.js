        ...
        <div className = "content">
                ...
                <div className = "footer-social">
                    <ul className = "footer-menu">
                        <li className="footer_social_facebook"><a href="/#"><i className="fa fa-facebook grey" aria-hidden="true"></i> </a></li>
                        <li className="footer_social_twitter"><a href="/#"><i className="fa fa-twitter grey" aria-hidden="true"></i> </a></li>
                        ...
                        <li className="footer_social_google"><a href="/#"><i className="fa fa-google grey" aria-hidden="true"></i> </a></li>
                    </ul>
                </div>
